...
rb_event_profiling_config_t *rb_setup_event_profiling(int max_ractors,
                                                      int max_ractor_events,
                                                      int
                                                      max_call_stack_depth);
void rb_finalize_event_profiling(const char *outfile);
...
#define RB_SYSTEM_EVENT_PROFILING_BEGIN_DEFAULT()                              \
    rb_event_profiling_begin(RB_EVENT_PROFILING_DEFAULT_INFO, true)
#define RB_SYSTEM_EVENT_PROFILING_END_DEFAULT()                                \
    rb_event_profiling_end(RB_EVENT_PROFILING_DEFAULT_INFO, true)
#define RB_SYSTEM_EVENT_PROFILING_BEGIN(name)                                  \
    rb_event_profiling_begin(RB_EVENT_PROFILING_NO_DEFAULT_INFO, name, true)
#define RB_SYSTEM_EVENT_PROFILING_END(name)                                           \
    rb_event_profiling_end(RB_EVENT_PROFILING_NO_DEFAULT_INFO, name, true)
#define RB_SYSTEM_EVENT_PROFILING_SNAPSHOT(reason)                             \
    rb_event_profiling_snapshot(RB_EVENT_PROFILING_DEFAULT_INFO, reason, true)
